...
// find the start of the old endpoint: app.get("/api/v1/admin/firebase-status"
// and find the next app.get("/api/v1/admin/verify"
// and replace everything between them.
const startIndex = code.indexOf('app.get("/api/v1/admin/firebase-status"');
const endIndex = code.indexOf('app.get("/api/v1/admin/verify"');
