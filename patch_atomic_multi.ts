...
const multiEnd = code.indexOf('public async voteHelpful(', multiStart);
...
`;
  ...
  console.log("Applied multi atomic update");
} else {
  console.log("Failed to find bounds", multiStart, multiEnd);
}
