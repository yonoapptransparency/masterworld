            ...
            {editingNewsId === item.id ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-7 space-y-6 flex flex-col">
                    <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-[20px] border border-black/5 dark:border-white/5 space-y-5">
                      ...
                      {item.logo_url && (
                        <div className="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm relative group max-h-72 bg-slate-100 dark:bg-slate-800 flex items-center justify-center p-2">
                          <img src={item.logo_url} className="max-w-full h-auto max-h-[250px] object-contain rounded-lg shadow-sm" loading="lazy" alt="Thumbnail Preview" />
                        </div>
                      )}
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div className="flex items-center gap-5 w-full">
                  <div className="w-36 h-24 rounded-xl overflow-hidden border border-black/5 dark:border-white/10 shrink-0 shadow-sm hidden sm:flex items-center justify-center bg-slate-100 dark:bg-slate-800 p-2">
                    <img src={item.logo_url || 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&q=80'} alt={item.title} loading="lazy" className="max-w-full max-h-full object-contain rounded-md" />
                  </div>
