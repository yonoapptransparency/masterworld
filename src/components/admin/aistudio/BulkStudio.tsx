        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <button
              ...
              className="w-full text-xs font-semibold bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-purple-700 dark:text-purple-400 mt-0.5 cursor-pointer text-left truncate flex items-center justify-between"
