export const DEFAULT_DISCLAIMER_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_ETHICS_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_PRIVACY_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_TERMS_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_RESPONSIBILITY_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_REPORT_REMOVAL_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export const DEFAULT_NOTICE_HTML = `<p>Please verify all application details and security ratings before downloading third-party software. RummyDex provides direct source links for verified mobile entertainment.</p>`;

export const DEFAULT_ABOUT_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<p>Welcome to RummyDex. The word "Dex" stands for index or directory, which perfectly describes our core identity. We are an independent digital library built to catalog, review, and provide structured, transparent information about casual games and digital applications.</p>

<h2>How We Provide Information &amp; Links</h2>
<p>We function strictly as an informational bridge. Instead of hosting direct software or APK files on our servers, we provide comprehensive technical breakdowns, clear guides, and safe, direct links to third-party developer sources.</p>

<h2>Real Hands-On Testing</h2>
<p>We do not just list apps blindly. Before any application is published on our platform, our team conducts a real, hands-on test. We personally experience the app's performance, mechanics, and user interface to ensure it meets our strict entertainment standards.</p>
