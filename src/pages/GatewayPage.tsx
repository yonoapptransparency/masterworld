...
export default function GatewayPage() {
  ...
  return (
    <div className="animate-fade-in select-none pb-20 w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-6 w-full lg:w-auto">
              <div className="relative w-24 h-24 bg-white dark:bg-zinc-800 rounded-[22px] overflow-hidden shadow-sm border border-black/5 dark:border-white/5 shrink-0">
                {app.icon_url ? <img src={app.icon_url} fetchPriority="high" alt={`${app.name} icon`} className="w-full h-full object-cover"/> : null}
              </div>
      ...
      <div className="py-16 mb-20 w-full px-4 sm:px-6 md:px-10 border-t border-black/5 dark:border-white/5">
