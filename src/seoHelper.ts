...
export async function injectSeoTags(template: string, urlPath: string, hostUrl?: string, userAgent: string = ''): Promise<SeoInjectionResult> {
  ...
  const seoTags = `
    ...
    <link data-rh="true" rel="icon" type="image/x-icon" href="/favicon.ico?v=3">
    <link data-rh="true" rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png?v=3">
    <link data-rh="true" rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png?v=3">
    <link data-rh="true" rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=3">
    <link data-rh="true" rel="apple-touch-icon-precomposed" href="/apple-touch-icon-precomposed.png?v=3">
