...
// Use a regular expression to cleanly replace the whole block between // Helper: Safe Decrypt (AES) and // Middleware
const newBlock = `// Helper: Safe Decrypt (AES)
...
content = content.replace(/\/\/ Helper: Safe Decrypt \(AES\)[\s\S]*?(?=\/\/ Middleware)/, newBlock + '\n');
