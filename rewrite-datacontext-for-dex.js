...
const dataContext = 'src/contexts/DataContext.tsx';
if (fs.existsSync(dataContext)) {
  fs.writeFileSync(dataContext, `import React, { createContext, useContext, useState } from 'react';
...
`, 'utf8');
  console.log("Rewrote DataContext.tsx for static-only data.");
}

const firebaseTs = 'src/lib/firebase.ts';
if (fs.existsSync(firebaseTs)) {
  fs.writeFileSync(firebaseTs, `
export const db = null;
export const auth = null;
export const app = null;
export const isFirebaseConfigured = false;
export const isFirebaseReal = false;
export const OperationType = { READ: 'READ', WRITE: 'WRITE', DELETE: 'DELETE' };
export const handleFirestoreError = () => {};
`, 'utf8');
  console.log("Rewrote firebase.ts to be a dummy module.");
}
